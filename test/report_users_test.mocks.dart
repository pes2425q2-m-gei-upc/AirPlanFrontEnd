...
// in airplan/test/report_users_test.dart.
...
import 'package:airplan/services/chat_websocket_service.dart' as _i5;
...
class MockChatWebSocketService extends _i1.Mock
    implements _i5.ChatWebSocketService {
  MockChatWebSocketService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Stream<Map<String, dynamic>> get chatMessages =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<bool> sendDeleteMessage(
  ...
  @override
  _i4.Future<bool> sendEditMessage(
    String? receiverUsername,
  ...
  @override
  _i4.Future<bool> sendChatMessage(
    String? receiverUsername,
    String? content,
    DateTime? timestamp,
  ) =>
  ...
  @override
  _i4.Future<bool> sendBlockNotification(
